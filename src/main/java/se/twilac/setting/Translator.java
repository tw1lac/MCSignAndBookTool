...
public class Translator {
	private Map<TextKey, String> translations;
	private File file;
	...
	public String toString() {
		...
		for (TextKey textKey : TextKey.values()) {
			stringBuilder.append(textKey.name()).append("=").append(textKey).append("\n");
		}
		return stringBuilder.toString();
	}

	public String getText(TextKey key) {
		return translations.getOrDefault(key, key.getDefaultTranslation());
