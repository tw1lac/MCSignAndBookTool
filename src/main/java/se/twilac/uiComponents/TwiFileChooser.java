...
public class TwiFileChooser extends JFileChooser {
	...
	public TwiFileChooser() {
		this(null);
	}
	public TwiFileChooser(SaveProfile saveProfile) {
...
//		setFilter(operationType);
		setCurrentDirectory(new File(saveProfile.getPath()));

		final int returnValue = showOpenDialog(getParent());
...
//		setCurrentDirectory(getCurrentDirectory());
	...
	public File saveFile(int operationType) {
		setDialogTitle("Save as");
//		setFilter(operationType);
//		setFileFilter(getFilter());
		setCurrentDirectory(getCurrentDirectory());

		final int returnValue = showSaveDialog(getParent());
		File file = getSelectedFile();
		setSelectedFile(null);
		if (returnValue == JFileChooser.APPROVE_OPTION) {
			if (file != null) {
	...
	public static void setCurrentPath(File file) {
		ProgramGlobals.getSaveProfile().setPath(file.getParent());
	}
