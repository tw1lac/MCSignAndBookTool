...
public class TwiListModel<E> extends AbstractListModel<E> implements Iterable<E> {
	...
	/**
	 * Constructs a TwiListModel linked with the list provided.
	 * Any changes in the list will reflect in the model and vice-versa.
	 *
	 ...
	 *
	 * @param anObject The value to be selected or null for no selection.
	 */
	...
	/**
	 * Adds all the elements present in the collection.
	 *
	...
	/**
	 * Adds all the elements present in the collection, starting
